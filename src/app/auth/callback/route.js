...
export async function GET(request) {
  ...
  if (!code) {
    // No code — something went wrong upstream. Send back to home.
  ...
  // Redirect to the app (or a specific post-login page).
  // Use a relative URL so it works on any domain (preview deploys, prod, etc.).
