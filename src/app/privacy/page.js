  ...
  return (
    <div className="max-w-[520px] mx-auto px-6 py-8 min-h-screen bg-bg">
      ...
      <div className="text-sm text-text-sec leading-relaxed flex flex-col gap-4">
        ...
        <p>Account and performance data are stored using Supabase. Access controls are designed so signed-in users can access only players and teams they manage or belong to.</p>
